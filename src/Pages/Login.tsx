...
function Login() {
  ...
  const onSubmit = (data: LoginFormInputs) => {
    dispatch(login({ ...data, type: userType as 'staff' | 'shopAdmin' }));
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-300 px-4">
      <form className="w-full max-w-md bg-white rounded-xl shadow-lg p-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="userType" className="block text-sm font-medium mb-1">Login as</label>
            <Select onValueChange={setUserType} defaultValue={userType}>
              ...
              <SelectContent>
                ...
                <SelectItem value="shopAdmin">Shop Admin</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div>
